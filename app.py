...
def index():
    ...
    # Logic: Only show coaches that are VERIFIED (1) and PAID
...
def coach_submit():
    ...
    # Set is_verified = 0 (Moves it to Admin Pending)
    ...
    db.commit()
    flash("Profile updated! FAROUK will review it shortly.", "success")
...
def admin_approve(sub_id):
    # Flip is_verified to 1 to make them go live
